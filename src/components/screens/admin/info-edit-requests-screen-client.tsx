...
import type { StreamerInfoEditRequest } from "@/types/admin-requests";
    ...
    <div className="mx-auto max-w-7xl p-6 md:p-10">
      <div className="mb-8">
        <div className="mb-1 flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-gray-900">버츄얼 정보수정요청</h1>
        </div>
        <p className="text-sm text-gray-500">유저가 보낸 버츄얼 정보 수정 요청 목록입니다.</p>
      </div>
