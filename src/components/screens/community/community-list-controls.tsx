...
type CommunityListControlsProps = {
  initialKeyword: string;
  initialSearchField: CommunityPostSearchField;
  placeholder: string;
};
...
export default function CommunityListControls({
  ...
  const [searchField, setSearchField] =
    useState<CommunityPostSearchField>(initialSearchField);

  function navigate(nextKeyword: string, nextSearchField: CommunityPostSearchField) {
  ...
  return (
    ...
    >
      ...
      <select
        value={searchField}
        onChange={(event) =>
          setSearchField(event.target.value as CommunityPostSearchField)
        }
