...
import type { CommunityDraftDialogProps } from "@/types/community-write";
import {
...
export default function CommunityDraftDialog({
  drafts,
  isLoading,
  isOpen,
  deletingDraftId,
                ...
                >
                  <div className="space-y-1">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span
                        className={`rounded-full px-2 py-0.5 text-[11px] font-medium ${getCommunityCategoryBadgeClassName(
                          draft.category
                        )}`}
                      >
                        {getCommunityCategoryLabel(draft.category)}
                      </span>
                    </div>
