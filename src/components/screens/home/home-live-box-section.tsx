...
export default function HomeLiveBoxSection({
  ...
  const useHorizontalScroll = topLiveBoxes.length >= 4;
          ...
          <div className="flex gap-3 overflow-x-auto pb-1">
            {topLiveBoxes.map((box) => (
              <Link
                ...
                className="group block min-w-[260px] shrink-0 rounded-xl border border-gray-200 bg-white p-3 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-gray-300 hover:bg-gray-50/40 hover:shadow-[0_14px_28px_-14px_rgba(0,0,0,0.45)] md:min-w-[300px]"
              >
